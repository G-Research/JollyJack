                    ...
                    src_offset_1 += src_stride0_size * BLOCK_SIZE)
              {
                        ...
                        src_offset_2 += src_stride0_size)
                  {
                            ...
                            src_offset += src_stride1_size * SSE_VECTOR_SIZE)
                      {
                          ...
                          __m128 v = _mm_set_ps(
                            *(float*)&src_ptr[src_offset + 3 * src_stride1_size],
                            *(float*)&src_ptr[src_offset + 2 * src_stride1_size],
                            *(float*)&src_ptr[src_offset + 1 * src_stride1_size],
                            *(float*)&src_ptr[src_offset]
                          );

                          // Store the vector to destination (destination is contiguous in memory)
                          _mm_storeu_ps((float*)&dst_ptr[dst_offset], v);
                      }
